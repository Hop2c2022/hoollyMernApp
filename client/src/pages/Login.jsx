...
const Login = () => {
  return (
    <div className="relative flex flex-col justify-center overflow-hidden h-[87.7vh] mt-[0.2vh] bg-[#111]">
      <div className=" p-8 w-3/5 m-auto bg-white shadow-xl max-w-md shadow-orange-100">
        ...
        <form className="mt-6">
          ...
          <div className="mt-6 flex justify-center pt-3">
            <button className="w-screen px-5 py-3 tracking-wide text-white font-semibold transition-colors duration-200 transform bg-orange-400 rounded-md hover:bg-orange-600 focus:outline-none">
              Log In
            </button>
          </div>
