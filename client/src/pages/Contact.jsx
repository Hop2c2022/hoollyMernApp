...
const Contact = () => {
  return (
    <div className="flex items-center md:h-[86.8vh] sm:h-[110vh] h-[150vh] justify-center">
      <section className=" text-gray-800 bg-[#111]  md:h-[86.8vh] h-full w-[100vw] flex justify-center items-center">
        <div className="block  rounded-lg shadow-lg bg-white md:w-[75vw] w-screen">
                ...
                <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
                  <div className="flex items-start">
                    ...
                    <div className="grow ml-6">
                      ...
                      <p className="text-gray-500">pinecone@gmail.com</p>
