...
const Contact = () => {
  return (
    <div className=" flex items-center justify-center bg-[#111]">
      <section className=" text-gray-800  lg:h-[93vh] md:h-[110vh] sm:h-[140vh] h-[170vh] w-[90vw] flex justify-center items-center">
        <div className="p-[20px] block  rounded-lg shadow-lg bg-white lg:w-[80vw] w-[95vw]">
          <div className=" flex flex-wrap items-center justify-center">
            <div className="grow-0 shrink-0 basis-auto block w-full lg:flex lg:w-6/12 xl:w-4/12">
              <div className="h-[500px] w-full">
                <iframe
                  src="https://maps.google.com/maps?q=Gurvan Gal Office Center&t=&z=13&ie=UTF8&iwloc=&output=embed"
