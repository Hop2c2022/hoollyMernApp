            ...
            <div className="mb-6 lg:mb-0 transition ease-in-out delay-200 hover:-translate-y-1 hover:scale-110 hover:bg-[#111] cursor-pointer duration-700 hover:shadow-yellow-300 hover:shadow-xl rounded-xl">
              <div className="backdrop-blur text-white block rounded-lg shadow-lg">
                <div className="relative overflow-hidden bg-no-repeat bg-cover">
                  <img
                    src="https://media.istockphoto.com/id/1041620710/photo/beautiful-sunflower-isolated-on-black-background.jpg?s=612x612&w=0&k=20&c=Nxv-jyQd1Q6uLF0D90VZ5pVhpI4zM7-TzewyaZ17VW8="
                ...
                <div className="p-6">
                  <div className="flex">
                    ...
                    <img
                      className="w-[18px] h-[18px] ml-[0.5vw] mt-[0.3vh]"
                  ...
                  <ul
                    onClick={() => (window.location = 'https://facebook.com/xashrdn')}
                    className="list-inside flex mx-auto justify-center"
                  >
                    <a className="px-2">
